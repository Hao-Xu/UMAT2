...
c        write(6,*) DSTRAN(I)
      enddo
         WRITE(666,'(I5,2X,19(E10.4,2X))') INC, (STRAN(I),I=1,3),
     1 (STRESS(I),I=1,3),(OMEGA(I),I=1,3),fd0,(STRAN(I),I=4,6), 
     2 (STRESS(I),I=4,6),(OMEGA(I),I=4,6) 
      END DO
      close(666)
